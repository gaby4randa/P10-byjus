...
//agregar al personaje principal
  sam = createSprite(20, 190, 13, 13);
  sam.shapeColor = "green";

  
//agregar carros(obstáculos)
...
//vidas igual a cero, terminar juego
  if(life <= 0){
    textSize(25);
    fill("red");
    text("FIN DEL JUEGO", 200, 350);
...
//ganar el juego
  if(sam.isTouching(boundary1)){
    textSize(25);
    fill("red");
    text("Felicidades, has ganado", 200, 350);
